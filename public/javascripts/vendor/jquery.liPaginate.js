...
(function($){
	$.fn.liPaginate = function(params){
		...
		return this.each(function(){
			...
			//Убираем фиксированную высоту страниц
			pageItemEl.css({height:'auto'})
			...
			pWrap.on('click','.pageLink',function(){
				...
				if(pWrap.offset().top < $(window).scrollTop()){
					$('body,html').animate({scrollTop:pWrap.offset().top})
				}
